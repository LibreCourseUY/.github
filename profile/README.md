...
🌐 [librecourse.uy](https://librecourse.uy) · 💬 [Discord](https://librecourse.uy/join/) · 📚 [Contributing guide](https://github.com/LibreCourseUY/.github/blob/master/CONTRIBUTING.md)
...
8. **Push and open a PR**: push to your fork and create a Pull Request.

New here? Check the [contributing guide](https://librecourse.uy/contribute/) and our [learning resources](https://librecourse.uy/learn/).
